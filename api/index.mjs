...
router4.post(
  "/",
  authMiddleware("TUTOR" /* TUTOR */),
  TutorAvailabilityController.createSlots
);
router4.get(
  "/:id",
  authMiddleware("TUTOR" /* TUTOR */),
  TutorAvailabilityController.getAvailableSlots
);
router4.patch(
  "/slot/:id",
  authMiddleware("TUTOR" /* TUTOR */),
...
router8.get(
  "/tutors",
  PublicController.browseTutors
);
router8.get(
  "/tutors/:id",
  PublicController.getTutorDetail
);
router8.get(
  "/categories",
  PublicController.getAllCategories
);
router8.get(
  "/all-students",
  PublicController.getAllStudents
);
router8.get(
  "/tutors/featured",
  PublicController.featuredTutors
);
